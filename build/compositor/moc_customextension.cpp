...
#include "../../compositor/customextension.h"
...
static const char qt_meta_stringdata_QtWayland__CustomExtension[] = {
    "QtWayland::CustomExtension\0\0text,value\0"
    "requestReceived(QString,uint)\0compositor\0"
    "initialize(QWaylandCompositor*)\0"
    "surface,time,text,value\0"
    "sendEvent(QWaylandSurface*,uint,QString,uint)\0"
};
...
const QMetaObjectExtraData QtWayland::CustomExtension::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QtWayland::CustomExtension::staticMetaObject = {
    { &QWaylandCompositorExtensionTemplate<CustomExtension>::staticMetaObject, qt_meta_stringdata_QtWayland__CustomExtension,
      qt_meta_data_QtWayland__CustomExtension, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QtWayland::CustomExtension::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtWayland__CustomExtension))
